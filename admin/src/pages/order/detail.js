...
* @Last Modified time: 2019-08-29 11:37:50
*/
...
class OrderDetail extends Component {
    ...
    componentDidMount(){
    	if(this.state.orderNo){
            this.props.handleDetail(this.state.orderNo)
        }
    }
	render(){
        const {
		...
		return(
			<Layout>
                <Breadcrumb style={{ margin: '16px 0' }}>
                    ...
                    <Breadcrumb.Item>处理订单</Breadcrumb.Item>
				</Breadcrumb>
...
const mapDispatchToProps = (dispatch)=>{
	return{
		handleDetail:function(orderNo){
            dispatch(actionCreator.getDetailAction(orderNo))
        },
        handleOrderDeliver:function(orderNo){
