 ...
 * @Last Modified time: 2019-08-21 16:13:50
 */
...
const WrappedNormalDetailForm = Form.create({ name: 'category' })(ProductDetail);
...
export default connect(mapStateToProps,mapDispatchToProps)(WrappedNormalDetailForm)